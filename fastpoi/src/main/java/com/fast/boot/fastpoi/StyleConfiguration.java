...
public class StyleConfiguration {
     ...
     * 内建样式
     */
    private final Map<Byte, CellStyle> buildInStyleMap = new HashMap<>(8);

    /**
     * 内建格式化
     */
    private final Map<Byte, DataFormat> buildInFormatMap = new HashMap<>(2);

    /**
     * 内建字体
     */
    private final Map<Byte, Font> buildInFontMap = new HashMap<>(2);

    /**
     * 用户自定义格式化样式
     */
    private final Map<String, CellStyle> customFormatStyleMap = new HashMap<>(8);
